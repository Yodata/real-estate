...
| additionalProperty.systemDeactivationDate | string | - |
| additionalProperty.inactiveDate | string | - |
| additionalProperty.goLiveDate | string | - |
| additionalProperty.originalAffiliationDate | string | - |
