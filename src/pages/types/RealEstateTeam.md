...
| 1.0.type | string | The item type (Linked-Data @type) |
| 1.0.@id | string | the liked data uri for the Thing |
| 1.0 (property names) | - | - |
| 1.1 (allOf item) | any | - |
| 1.2 (allOf item) | any | - |
| 1.3 (allOf item) | - | - |
...
| 1.3.certification.0.issuedBy.id | string | Linked-Data URI (@id) |
...
| 1.3.certification.0.issuedTo.id | string | Linked-Data URI (@id) |
...
| 1.3.contactPoint.email | string | an email address for the item. |
| 1.3.contactPoint.url | string | primary URL for the item. |
| 1.3.email | string | - |
...
| 1.3.image.0.0.0.type | string | The item type (Linked-Data @type) |
| 1.3.image.0.0.0.@id | string | the liked data uri for the Thing |
| 1.3.image.0.0.0 (property names) | - | - |
| 1.3.image.0.0.1 (allOf item) | - | - |
| 1.3.image.0.0.1.type | string | - |
| 1.3.image.0.0.1.id | string | the URL to access the item. |
| 1.3.image.0.0.1.name | string | the file name of the object. |
| 1.3.image.0.0.1.encodingFormat | string | MIME type |
| 1.3.image.0.0.1.about | string | URI to the subject of the image or logo |
| 1.3.image.0.0.1.url | string | URL of the image content |
...
| 1.3.parentOrganization (single item) | string | - |
| 1.3.subOrganization | array<string> | a child organization |
| 1.3.subOrganization (single item) | string | - |
| 1.3.telephone | string | Primary phone number. |
| 1.3.type | string | - |
| 1.3.url | string | primary website/url for the entity. |
...
| 2.parentOrganization (single item) | string | - |
...
| 2.member.0.member | string | member object or id |
| 2.member.0.startDate | string | date the member began performing this role |
| 2.member.0.endDate | string | date the member stopped performing the role |
...
| 2.member.1.memberOf | string | - |
| 2.member.1.member | string | - |
