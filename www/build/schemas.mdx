...
|:--------- | :--- | :---------- |
| type | string&lt;regex&gt;! | the type of action  |
| actionStatus | string | Indicates the current disposition of the Action.  |
| agent | object | The direct performer or driver of the action. <br/>RANGE: [Organization](/schemas#organization),[Person](/schemas#person) |
| endTime | string&lt;date-time&gt; | The endTime of something.  |
| error | object | For failed actions, more information on the cause of the failure. <br/>RANGE: [Thing](/schemas#thing) |
...
```json
{
  ...
  "roleName": "string",
  "startDate": "2019-02-19T07:53:37Z",
  "endDate": "2019-02-19T07:53:37Z"
}
```
## MLSMembership
...
```json
{
  ...
  "validFrom": "2019-02-19T07:53:37Z",
  "validUntil": "2019-02-19T07:53:37Z"
}
```
