...
| data.object.recipient | string | format (`uri`) the lead recipient |
| data.object.sender | string | format (`uri`) the lead provider |
| data.object.owner | string | format (`uri`) the original owner of the lead |
| data.object.dateAccepted | string | The date/time the item was accepted by the recipient |
| data.object.dateRejected | string | format (`date-time`) The date/time the item was rejected by the recipient |
| data.object.dateSent | string | format (`date-time`) the date the lead was sent |
...
| data.agent | string | format (`uri`) the assignor, typically the lead owner |
| data.recipient | string | format (`uri`) the assignee of the lead. |
