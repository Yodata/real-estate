...
| data.object | string | format (`uri`) the profile uri of the team member being added |
...
| data.targetCollection.member (single item) | string | examples (`"http://12345.example.com/profile/card#me"`, `"http://ma302-001.example.com/profile/card#me"`, `"http://ma302.example.com/profile/card#me"`) format (`uri`)  |
| topic | string | const (`"realestate/award#teammemberadd"`)  |
| data | object | - |
| data.type | string | const (`"AddAction"`)  |
| data.object | string | format (`uri`) the profile uri of the team member being added |
