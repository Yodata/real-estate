...
| data.agent | string | user who effected the change <span class='constraints'>format (`uri`)</span> |
| data.participant | object | - |
| data.participant.type | string | - |
| data.participant.id | string |  <span class='constraints'>format (`uri`)</span> |
