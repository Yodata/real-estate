...
| data.object.dateAwarded | string | format (`date-time`) date the award was presented or announced. |
| data.object.agent | string | format (`uri`) the agent that presented the award |
