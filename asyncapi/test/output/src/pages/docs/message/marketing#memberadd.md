              ...
              "allOf": [
                {
                  "allOf": [
                    ...
                    },
                    {
                      "x-range": "AddAction",
                      "title": "AddAction",
                      "description": "data (object) is added by user (agent), optionally to the targetCollection",
                      "properties": {
                        "type": {
                        ...
                        "targetCollection": {
                          "type": "object",
                          "description": "the collection or reference to the collection receiving the data"
                        }
                      }
                    }
                  ]
