...
---
## Message contact#update `contact#update`

*a contact (data.object) is updated by a user (data.agent)*

* Message ID: `contact#update`
...
| data.object.0.affiliation (single item) | string | - |
...
| data.object.0.birthDate | string | date of birth. |
...
| data.object.1.dateCreated | string | The date on which the item was created. |
| data.object.1.dateModified | string | The date on which the item was most recently modified or when the item's entry was modified within a DataFeed. |
