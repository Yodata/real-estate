...
---
## Message website#listingoffer `website#listingoffer`

*website user makes a listing offer*

* Message ID: `website#listingoffer`
...
| data.recipient.0.certification.issuedBy.id | string | Linked-Data URI (@id) |
...
| data.recipient.0.certification.issuedTo.id | string | Linked-Data URI (@id) |
| data.recipient.0.certification.issuedTo.name | string | the name of the item |
| data.recipient.0.contactPoint | object | A point of contact for the entity. By convention in the real estate domain, ContactPoints are preferred over telephone, email, and faxNumber so the ContactPoint.name property can be used to label values for example, Work Telephone, Home, as named contactPoint values. |
...
| data.recipient.0.contactPoint.email | string | an email address for the item. |
| data.recipient.0.contactPoint.url | string | primary URL for the item. |
| data.recipient.0.email | string | - |
| data.recipient.0.familyName | string | Last Name of a person. [Family Name](https://schema.org/familyName) |
| data.recipient.0.givenName | string | First Name of a person |
| data.recipient.0.id | string | Linked-Data URI (@id) |
...
| data.recipient.0.image.0.0.0.type | string | The item type (Linked-Data @type) |
| data.recipient.0.image.0.0.0.@id | string | the liked data uri for the Thing |
| data.recipient.0.image.0.0.0 (property names) | - | - |
| data.recipient.0.image.0.0.1 (allOf item) | - | - |
| data.recipient.0.image.0.0.1.type | string | - |
| data.recipient.0.image.0.0.1.id | string | the URL to access the item. |
...
| data.recipient.0.image.0.0.1.about | string | URI to the subject of the image or logo |
| data.recipient.0.image.0.0.1.url | string | URL of the image content |
...
| data.recipient.0.memberOf.0.member | string | member object or id |
| data.recipient.0.memberOf.0.startDate | string | date the member began performing this role |
| data.recipient.0.memberOf.0.endDate | string | date the member stopped performing the role |
| data.recipient.0.memberOf.1 (anyOf item) | string | - |
...
| data.recipient.0.parentOrganization (single item) | string | - |
...
| data.recipient.0.permit.validFrom | string | start date |
| data.recipient.0.permit.validUntil | string | end date |
| data.recipient.0.subOrganization | array<string> | child organizations of the organization |
| data.recipient.0.subOrganization (single item) | string | - |
| data.recipient.0.url | string | URL of the item. |
...
| data.recipient.1.affiliation (single item) | string | - |
...
| data.recipient.1.birthDate | string | date of birth. |
...
| data.recipient.1.contactPoint.email | string | an email address for the item. |
| data.recipient.1.contactPoint.url | string | primary URL for the item. |
| data.recipient.1.email | string | - |
...
| data.recipient.1.familyName | string | Last Name of a person. [Family Name](https://schema.org/familyName) |
