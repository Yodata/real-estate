...
title: profile#add
---
## Message profile#add `profile#add`

*an agent, office or organization profile was added*

* Message ID: `profile#add`
...
| data.object.1.0.0.0.type | string | The item type (Linked-Data @type) |
| data.object.1.0.0.0.@id | string | the liked data uri for the Thing |
| data.object.1.0.0.0 (property names) | - | - |
...
| data.object.1.0.0.3.certification.0.issuedBy.id | string | Linked-Data URI (@id) |
...
| data.object.1.0.0.3.certification.0.issuedTo.id | string | Linked-Data URI (@id) |
...
| data.object.1.0.0.3.contactPoint.email | string | an email address for the item. |
| data.object.1.0.0.3.contactPoint.url | string | primary URL for the item. |
| data.object.1.0.0.3.email | string | - |
...
| data.object.1.0.0.3.image.0.0.0.type | string | The item type (Linked-Data @type) |
| data.object.1.0.0.3.image.0.0.0.@id | string | the liked data uri for the Thing |
| data.object.1.0.0.3.image.0.0.0 (property names) | - | - |
| data.object.1.0.0.3.image.0.0.1 (allOf item) | - | - |
| data.object.1.0.0.3.image.0.0.1.type | string | - |
| data.object.1.0.0.3.image.0.0.1.id | string | the URL to access the item. |
...
| data.object.1.0.0.3.image.0.0.1.about | string | URI to the subject of the image or logo |
| data.object.1.0.0.3.image.0.0.1.url | string | URL of the image content |
...
| data.object.1.0.0.3.parentOrganization (single item) | string | - |
| data.object.1.0.0.3.subOrganization | array<string> | a child organization |
| data.object.1.0.0.3.subOrganization (single item) | string | - |
| data.object.1.0.0.3.telephone | string | Primary phone number. |
| data.object.1.0.0.3.type | string | - |
| data.object.1.0.0.3.url | string | primary website/url for the entity. |
...
| data.object.1.0.1.parentOrganization (single item) | string | - |
...
| data.object.1.0.1.member.0.member | string | member object or id |
| data.object.1.0.1.member.0.startDate | string | date the member began performing this role |
| data.object.1.0.1.member.0.endDate | string | date the member stopped performing the role |
| data.object.1.0.1.member.1 (anyOf item) | string | - |
...
| data.object.1.0.1.memberOf.0.member | string | member object or id |
| data.object.1.0.1.memberOf.0.startDate | string | date the member began performing this role |
| data.object.1.0.1.memberOf.0.endDate | string | date the member stopped performing the role |
...
| data.object.1.0.1.memberOf.1.member | string | - |
...
| data.object.1.1.subOrganization (single item) | string | - |
