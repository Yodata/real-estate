...
name: About Project REflex
menu: Introduction
---

REflex is a framework for vendor-agnostic software integration in the real estate industry.

## Project Motivation
Data on the Web should not be locked in to particular systems or be only readable by the applications which created it. 
Users should be free to switch between applications and share data between them.
