...
| data.agent | string | the assignor, typically the lead owner <span class='constraints'>format (`uri`)</span> |
| data.recipient | string | the assignee of the lead. <span class='constraints'>format (`uri`)</span> |
| topic | string | - |
| data | object | - |
| data.type | string | - |
| data.object | object | a sales opportunity (object) offered by a sender to a recipient. |
