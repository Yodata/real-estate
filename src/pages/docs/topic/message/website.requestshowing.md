...
---
## Message website#requestshowing `website#requestshowing`

*a website visitor has requested a property showing*

* Message ID: `website#requestshowing`
...
| data.event.startDate | string | the start date-time (ISO 8601 formated) |
| data.event.endDate | string | the end date-time (ISO 8601 formated) |
