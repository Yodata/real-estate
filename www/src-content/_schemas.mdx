...
| availableLanguage | [undefined] | A language someone may use with or at the item, service or place. Please use one of the language codes from the IETF BCP 47 standard.  |
...
| image | [array] | an ImageObject or URI reference to an image of the entity on the web.  |
  ...
  "permit": [
    {
      ...
      "validFrom": "2019-03-03T18:32:53Z",
      "validUntil": "2019-03-03T18:32:53Z"
    }
  ]
}
```
