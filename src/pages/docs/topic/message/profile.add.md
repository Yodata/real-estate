...
| *.additionalProperty.bhhsLeadNotificationPreference.leadNotificationSchedule | string | type , name, byDay (`"Monday"`, `"Tuesday"`,`"Wednesday"`, `"Thursday"`,`"Friday"`, `"Saturday"`, `"Sunday"`)   |
